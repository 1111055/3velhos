        ...
        <div id="form">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('password.request') }}">
               ...
               <div class="form-item">
                    ...
                    <input id="email" type="email" class="form-style" name="email" placeholder="Email" value="{{ $email }}" required readonly>
                 ...
                 <div class="form-item">
                    ...
                    <input id="password-confirm" type="password" class="form-style" placeholder="Confirmar Password" name="password_confirmation" required>
