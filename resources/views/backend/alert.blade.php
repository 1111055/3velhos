         ...
         <!--Alerta de sucess-->
          ...
          @endif
           @if ($errors->any())
                <div class="alert alert-danger" id="showerror" style="border-radius: 0; float: right; margin-top: 2%; position: fixed; right: 0; top: 0; width: 600px; z-index: 9999;margin-right: 30%;">
                    <ul>
